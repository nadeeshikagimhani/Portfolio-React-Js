...
const Navbar = ({ darkMode, toggleDarkMode}) => {
  ...
  return (
    <div className="flex justify-center w-full fixed z-50 mt-4">
        ...
        backdrop-blur-lg rounded-2xl px-4 lg:px-8 py-4 shadow-lg`}>
            ...
            <div className="flex items-center justify-between w-full space-x-8 lg:space-x-10">
                ...
                <div className="flex items-center space-x-5">
                    ...
                    className={`p-2 rounded-full ${darkMode ? `bg-gray-700` : `bg-white`} transition-colors`}
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`hidden lg:block px-8 py-2 -mr-8 font-semibold rounded-full bg-linear-to-r ${colors.button}
                ...
                <div className="flex lg:hidden items-center space-x-4 px-2">
                    ...
                    className={`p-2 rounded-lg ${darkMode ? `bg-gray-700` : `bg-white`}`}>
