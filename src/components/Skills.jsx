...
const Skills = ({ darkMode }) => {
    ...
    const skills = [
        {name: 'lravel', icon: laravel, level: 95, color: 'from-orange-500 to-amber-500'},
                            ...
                            transition-all duration-300 hover:-translate-y-2 group hover:shadow-[0_0_30px_rgb(255,165,0,0,0.15)]'>
                                <div className='flex items-center mb-6'>
                                    ...
                                    style={{
                                        ...
                                        : 'linear-gradient(to bottom right, #3ff4f6, #e5e7eb)'
                                    }}
                                    className='w-16 h-16 rounded-xl p-3 flex items-center justify-center
                                    group-hover:scal-110 transition-transform duration-300'>
                                        <img
                                        src={skills.icon}
                                        alt={skills.name}
                                ...
                                style={{
                                    ...
                                    ${skills.color} transition-all duration-1000 ease-out`}
                                ...
                                ${darkMode ? 'border-gray-700' : 'border-gray-300'}`}>
                                    <div
                                    className='h-1 rounded-full opacity-70 group-hover:w-full transition-all
                                    duration-500 w-1/3'
                                    style={{
                                        background: 'linear-gradient(to right, #f97316, #f59e0b)'
                                    }}></div>
