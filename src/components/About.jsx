        ...
        gap-8 sm:gap-12 items-center'>
            ...
            className='flex flex-wrap justify-center gap-4 relative order-2 lg:order-1'>
                ...
                <div className='relative w-75 h-75 lg:w-96 lg:h-96'>
                    ...
                    {/* IMAGE */}
                    <div className='absolute -inset-4 lg:-inset-20 bg-linear-to-r
            ...
            lg:order-2'>
                ...
                <header>
                    ...
                    font-bold mb-4 sm:mb-6 text-transparent bg-linear-to-r
                ...
                <p className={`text-sm sm:text-base lg:text-lg xl:text-xl mb-6
                    sm:mb-8 leading-relaxed bg-linear-to-r from-orange-900/10 to-orange-900/5
                ...
                <button className={`w-full sm:w-auto border-2 border-orange-500 inline-flex items-center justify-center
