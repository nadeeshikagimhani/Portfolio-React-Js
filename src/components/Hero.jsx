    ...
    <div className='relative overflow-hidden min-h-screen flex flex-col'>
      ...
      className='body-font z-10'>
            ...
            <div className='w-full pt-4 sm:pt-8'>
              ...
              data-aos-delay='800'>
                ...
                <a href={CV} download className='w-full sm:w-auto'>
                  ...
                  text-white bg-linear-to-r from-orange-500 to-amber-500 border-0 py-3
                  px-6 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)]
        ...
        <div className={`absolute -top-20 -left-20 w-40 h-40 sm:w-64 sm:h-64
          ${theme.decorativeCircle} rounded-full mix-blend-multiply filter
          blur-3xl opacity-10 animate-pulse delay-1000 hidden sm:block`}>
